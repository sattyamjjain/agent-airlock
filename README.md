...
**Test suite:** 2,195 tests · **Coverage:** 82.16% · **v0.6.1**
<!-- TEST-BADGE-END -->
...
**Adapter-shipped (9):** LangChain (`integrations/langchain.py`),
...
**Example-only (4):** PydanticAI, CrewAI, AutoGen, LlamaIndex —
...
| PydanticAI | [example only](./examples/pydanticai_integration.py) | Dependencies, structured output |
| LlamaIndex | [example only](./examples/llamaindex_integration.py) | ReActAgent |
| CrewAI | [example only](./examples/crewai_integration.py) | Crews, roles |
...
| [**Examples**](./examples/) | 13 framework integrations (9 adapter-shipped + 4 example-only) with copy-paste code |

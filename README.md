...
**Test suite:** 3,640 tests · **Coverage:** 86.69% · **v0.8.60**
<!-- TEST-BADGE-END -->
...
> **On the `2026-07-28`-tagged guards below:** MCP `2026-07-28` is a [release candidate](https://github.com/modelcontextprotocol/modelcontextprotocol/releases/tag/2026-07-28-RC) (`prerelease: true`, verified 2026-07-28), not a ratified revision. Those guards are forward-compatible hardening and are **not a conformance claim**; the negotiated protocol version remains `2025-11-25`, the ratified revision.

...
**Test suite:** 3,694 tests · **Coverage:** 86.69% · **v0.8.68**<br>
<sub>Coverage runs 3,682 of 3,694; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

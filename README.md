...
**Test suite:** 3,828 tests · **Coverage:** 86.85% · **v0.8.71**<br>
<sub>Coverage runs 3,816 of 3,828; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

...
**Test suite:** 4,220 tests · **Coverage:** 87.34% · **v0.8.84**<br>
<sub>Coverage runs 4,208 of 4,220; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

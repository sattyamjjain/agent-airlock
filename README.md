...
**Test suite:** 3,721 tests · **Coverage:** 86.76% · **v0.8.69**<br>
<sub>Coverage runs 3,709 of 3,721; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->
...
| **MCP02 Privilege Escalation via Scope Creep** | preset `require_agent_id` + capability gating + `CredentialScope` | Full |

...
**Test suite:** 3,838 tests · **Coverage:** 86.85% · **v0.8.71**<br>
<sub>Coverage runs 3,826 of 3,838; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

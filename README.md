...
| **MCP07 Insufficient Authentication** | OAuth 2.1 + PKCE S256 helpers in `mcp_spec.oauth`; SEP-2468 `iss` mix-up validation (`mcp_spec_2026_07_defaults`); SEP-2243 header/body routing integrity (`mcp_spec_2026_07_header_integrity_defaults`); unsigned-`_meta` trust boundary (`mcp_meta_trust_2026_07_defaults`) |

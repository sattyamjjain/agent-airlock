...
**Test suite:** 3,749 tests · **Coverage:** 86.85% · **v0.8.70**<br>
<sub>Coverage runs 3,737 of 3,749; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

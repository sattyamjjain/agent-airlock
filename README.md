...
**Test suite:** 3,845 tests · **Coverage:** 86.84% · **v0.8.72**<br>
<sub>Coverage runs 3,833 of 3,845; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

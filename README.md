...
**Test suite:** 4,123 tests · **Coverage:** 87.27% · **v0.8.82**<br>
<sub>Coverage runs 4,111 of 4,123; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

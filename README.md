...
**Test suite:** 3,575 tests · **Coverage:** 85.92% · **v0.8.56**
<!-- TEST-BADGE-END -->
...
> Static review aid, Pydantic-only, zero-dep core. The shipped surface is the
> `airlock-scan-tools` console script (and `python -m agent_airlock.cli.scan_tools`);
> the unified `airlock scan-tools` space-form lands with the deferred dispatcher PR.

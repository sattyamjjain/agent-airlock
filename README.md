...
**Test suite:** 2,251 tests · **Coverage:** 82.20% · **v0.7.1**
<!-- TEST-BADGE-END -->
...
**Adapter-shipped (10):** LangChain (`integrations/langchain.py`),
...
**Example-only (3):** CrewAI, AutoGen, LlamaIndex —
...
| [**Examples**](./examples/) | 13 framework integrations (10 adapter-shipped + 3 example-only) with copy-paste code |

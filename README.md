...
**Test suite:** 3,832 tests · **Coverage:** 86.85% · **v0.8.71**<br>
<sub>Coverage runs 3,820 of 3,832; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

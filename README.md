...
**Test suite:** 4,013 tests · **Coverage:** 87.05% · **v0.8.77**<br>
<sub>Coverage runs 4,001 of 4,013; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

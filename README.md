...
**Test suite:** 3,665 tests · **Coverage:** 86.70% · **v0.8.62**<br>
<sub>Coverage runs 3,653 of 3,665; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

...
Regeneration harness: [`benchmarks/vs_gateway/gateway_harness/`](https://github.com/sattyamjjain/agent-airlock/tree/main/benchmarks/vs_gateway/gateway_harness).

...
**Test suite:** 4,288 tests · **Coverage:** 87.21% · **v0.8.86**<br>
<sub>Coverage runs 4,276 of 4,288; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

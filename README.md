...
**Test suite:** 4,810 tests · **Coverage:** 87.96% · **v0.10.18**<br>
<sub>Coverage runs 4,797 of 4,810; the 13 excluded are 8 benchmark tests (not correctness tests) and 5 docker-marked (need a daemon — they run in CI's `docker-sandbox` job, against the image built from the Dockerfile at the repo root).</sub>
<!-- TEST-BADGE-END -->

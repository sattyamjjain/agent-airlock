...
**Test suite:** 4,059 tests · **Coverage:** 87.27% · **v0.8.78**<br>
...
| **Native MCP gateway head-to-head** · 12 malformed tool-call payloads, identical to both layers · `python -m benchmarks.vs_gateway` | **12/12 blocked · 0% false-positive · p50 ~0.08ms/decision** | Docker MCP Gateway **v2.0.1 — 0/12 blocked** · _re-measured live 2026-08-17 (`docker mcp` v0.42.1 / engine 29.4.3): sent each payload as a real MCP `tools/call`; the gateway forwarded every one to the backend. Hub's moving `v2` tag was rebuilt 2026-07-23, so a newer build exists that this run did not measure — see RESULTS.md_ |
...
| **Core dependencies** | 0 (Pydantic only)[^deps] |

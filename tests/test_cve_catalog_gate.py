...
2. **Honesty of the split** — 40 regression modules exist, 33 are CVE-numbered, and the
   published wording says both rather than implying the catalog holds all 40. The other

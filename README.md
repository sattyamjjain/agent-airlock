...
**Test suite:** 4,164 tests · **Coverage:** 87.27% · **v0.8.83**<br>
<sub>Coverage runs 4,152 of 4,164; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

...
**Test suite:** 3,899 tests · **Coverage:** 86.92% · **v0.8.75**<br>
<sub>Coverage runs 3,887 of 3,899; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

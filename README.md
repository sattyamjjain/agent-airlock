...
**Test suite:** 4,002 tests · **Coverage:** 87.05% · **v0.8.77**<br>
<sub>Coverage runs 3,990 of 4,002; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->

...
**Test suite:** 3,911 tests · **Coverage:** 86.94% · **v0.8.76**<br>
<sub>Coverage runs 3,899 of 3,911; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->
...
deterministically against the installed package. Verified 2026-08-18.

...
**Test suite:** 4,828 tests · **Coverage:** 88.06% · **v0.10.19**<br>
<sub>Coverage runs 4,815 of 4,828; the 13 excluded are 8 benchmark tests (not correctness tests) and 5 docker-marked (need a daemon — they run in CI's `docker-sandbox` job, against the image built from the Dockerfile at the repo root).</sub>
<!-- TEST-BADGE-END -->

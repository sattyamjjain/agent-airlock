...
- **Refresh the test count** to the current README TEST-BADGE at submission time (v0.8.79 = 4,059).
...
4,059 tests. Listed under Tools/Clients since it wraps servers rather than being
one.

...
**Test suite:** 4,106 tests · **Coverage:** 87.27% · **v0.8.80**<br>
<sub>Coverage runs 4,094 of 4,106; the 12 excluded are 8 benchmark tests (not correctness tests) and 4 docker-marked (need a daemon).</sub>
<!-- TEST-BADGE-END -->
